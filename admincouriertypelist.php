...
<table border="1" cellpadding="5" cellspacing="5"> 
    <tr> <td height="20" colspan="2"> <img style="-webkit-user-select: none" src="images/couriertypelist.bmp"> </td> </tr>   
<?php 
                $result = $conn->query("select * from CourierTypeTab order by CourierTypeName");
